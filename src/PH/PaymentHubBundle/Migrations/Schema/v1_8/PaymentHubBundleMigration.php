...
class PaymentHubBundleMigration implements Migration
{
    ...
    public function up(Schema $schema, QueryBag $queries)
    {
        ...
        $queries->addQuery('ALTER TABLE ph_subscription ADD CONSTRAINT FK_98E208AC59294170 FOREIGN KEY (business_unit_owner_id) REFERENCES oro_business_unit (id);');
        $queries->addQuery('ALTER TABLE ph_subscription ADD CONSTRAINT FK_98E208AC32C8A3DE FOREIGN KEY (organization_id) REFERENCES oro_organization (id);');
