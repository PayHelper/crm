...
class PaymentHubBundleMigration implements Migration
{
    ...
    public function up(Schema $schema, QueryBag $queries)
    {
        ...
        $queries->addQuery('ALTER TABLE ph_customer ADD CONSTRAINT FK_1E65785C59294170 FOREIGN KEY (business_unit_owner_id) REFERENCES oro_business_unit (id);');
        $queries->addQuery('ALTER TABLE ph_customer ADD CONSTRAINT FK_1E65785C32C8A3DE FOREIGN KEY (organization_id) REFERENCES oro_organization (id);');
